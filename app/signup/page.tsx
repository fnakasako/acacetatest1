    ...
    <div style={{
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <input
          ...
          required
          className="input-field"
          style={{ marginBottom: '20px' }} // Ensure margin bottom for password input
        />
      ...
      <p style={{ paddingTop: '20px' }}>
        Already have an account? <Link href="/login" legacyBehavior><a style={{ color: 'blue', textDecoration: 'underline' }}>Login</a></Link>
      </p>
    </div>
  );
};
